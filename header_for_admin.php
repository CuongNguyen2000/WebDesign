...
<body>
    ...
    <ul>
      	<li class="active">
      		<a href="http://localhost:8080/ASM2-WebDesign/Admin_product.php">
        ...
        <div class="dropdown">
          ...
          <a href="http://localhost:8080/ASM2-WebDesign/addProduct.php">Add New Product</a>
        </li>
        <li style="float: right;">
